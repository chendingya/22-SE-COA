...
public class ALUMulTest {
	...
	public void MulTest2() {
		src = new DataType("00000000000000000000000000000111");
	...
	public void MulTest3() {
		src = new DataType("00000000000000000000000000001001");
		dest = new DataType("00000000000000000000000000001010");
		result = alu.mul(src, dest);
		assertEquals("00000000000000000000000001011010", result.toString());
	}
	@Test
