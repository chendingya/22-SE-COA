...
public class FPUMulTest {
	...
	@Test
	public void fpuMulTesto(){
		src = new DataType("10000000010000000000000000000000" );
		dest = new DataType("00111111100110011001100110011010" );
		result = fpu.mul(src, dest);
		assertEquals("10000000010011001100110011001101", result.toString() );
	}
