...
public class Disk {
    ...
    private static class DiskHead {
        ...
        public void seek(int start) {
            // TODO
            int diskNow = (int) (start / Math.pow(2, 23));
            track = (int) ((start - diskNow * Math.pow(2, 23) ) / Math.pow(2, 15));
            sector = (int) ((int) (start - diskNow * Math.pow(2, 23) - track * Math.pow(2, 15) ) / Math.pow(2, 9));
            point = (int) (start - diskNow * Math.pow(2, 23) - track * Math.pow(2, 15) - sector * Math.pow(2, 9));
        }
