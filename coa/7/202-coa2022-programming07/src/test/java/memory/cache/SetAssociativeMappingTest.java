...
//
        System.out.println("******* checkstatus  tianman");
//
...
//
        System.out.println("******* checkstatus " + 0);
//
        assertTrue (cache.checkStatus(new int[]{0}, new boolean[]{true}, new char[][]{"00000000000000010100000000".toCharArray()}));
...
//
        assertTrue (cache.checkStatus(new int[]{1}, new boolean[]{true}, new char[][]{"00000000000000011100000000".toCharArray()}));

        // cache中的第4行和第8行应该被替换
        memory.write(pAddr4, input4.length, input4);
        dataRead = cache.read(pAddr4, input4.length);
//
        System.out.println("******* array equals 4 8 ");
//
        assertArrayEquals(input4, dataRead);
//
        System.out.println("******* checkstatus 4 8 ");
//
